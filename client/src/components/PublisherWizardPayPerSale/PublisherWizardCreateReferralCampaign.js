...
export const PublisherWizardCreateReferralCampaign = ({ step }) => {
    if (step !== 1) {
      ...
      return (
        <Fragment>
          <div>
            <CustomLabel labelColor={'#696868'} labelFontSize={18} labelMargin={'0 0 12px 0'} htmlFor="url">Your website URL</CustomLabel>
            <div>
          ...
          <div>
            <CustomLabel labelColor={'#696868'} labelFontSize={18} labelMargin={'0 0 12px 0'} htmlFor="reward">Reward per click</CustomLabel>
            <div>
