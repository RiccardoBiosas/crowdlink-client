...
export const PublisherWorkflow = () => {
  ...
  console.log('workflow context.active ', active)
  ...
  return (
    <CardContainerLayout>       
      <CardLayoutWithBorder>
        ...
        <CardSubContainer subContainerHeight={'100%'} subContainerWidth={'100%'} justify={"space-around"} align={"center"}>
          ...
          <RowContainer containerJustify={'around'} containerWidth={'100%'}>
            ...
            <div>
              <ParagraphButton
                ...
                onClick={() =>
                  history.push({
                    pathname: active ? `${PUBLISHER_DASHBOARD_ROUTE_WITH_PARAM}/clicks` : PUBLISHER_SIGN_UP_ROUTE,
